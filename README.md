...
- **[AgentClear](https://agentclear.dev)** — API marketplace for agents. Discover and call 60+ external services (PDF extraction, image generation, web scraping) with semantic search and automatic micropayment billing. Python: `pip install agentclear`, Node: `npm install @agentclear/sdk`.
