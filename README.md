...
| [keelstack-me/guard](https://github.com/KeelStack-me/guard) | Runtime guardrails for TypeScript AI agents: idempotency gate, per-user cost budgets, and risk policies for irreversible actions. Zero deps. MIT. |  ![GitHub stars](https://img.shields.io/github/stars/KeelStack-me/guard?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/KeelStack-me/guard) |
