...
| [raphaelchristi/harness-evolver](https://github.com/raphaelchristi/harness-evolver) | LangSmith-native autonomous agent optimization. Spawns parallel proposer agents that evolve any LangGraph/LangChain agent using LangSmith Datasets, Experiments, and LLM-as-judge evaluation | ![GitHub stars](https://img.shields.io/github/stars/raphaelchristi/harness-evolver?style=social) |
